...
เริ่มเกมส์ที่จุดเริ่มต้น > ดึงค่าแสดงผลโดยใช้ที่ถูกกำหนดตามทิศทางของปุ่ม > อัพเดตสถานะจุดเปลี่ยนแต่ละรูปแบบ > เงื่อนไขที่ตอบสนองทันทีจากการเคลื่อนที่ของจุดก่อนหน้าโดยการควบคุม > ผลการแสดงค่าเสร็จสิ้นเข้าสู่ 1 จบ/เทิร์น

<!-- 2.1. Board Functions (Hardcoded) -->

เราต้องการให้ PLAYER เดินทางตามหา HAT โดยระวังอย่าให้โดนลง HOLE โดยการนำทางผ่านคีย์ต่างๆโดย W,A,S,D ที่ใช้ในการบังคับ

<!-- 2.2. Board Functions (Generated) -->

<!-- 3. Input Functions -->

ใช้ค่าที่ถูกกำหนดแต่ละทิศทางของปุ่มควบคุม จากนั้นให้มีการแสดงผลออกมาในรูปแบบตัวอักษรเพื่อ Print ค่าออกมาตามที่เราต้องการ

<!-- 4. Movement Functions -->

ค่าแสดงการควบคุมผ่าน " W,A,S,D " ที่ใช้ค่า ROW,COL เพื่อกำหนดค่าแสดงผลการเดินออกมา

<!-- 5. Game Rule Functions -->

การเข้าเงื่อนไขให้แสดงผลออกมา โดยทราบค่าสถานะของ PLAYER ผ่านสถานะหรือความรู้สึกแต่ละช่วงเวลา

<!-- 6. Game Play Loop -->

การแสดงผล 1 LOOP จะได้ผลลัพธ์แล้วออกมานั้นเป็นจริง แล้ววน LOOP ออกมาเมื่อถึงจุดปลายทาง

[Back to Table of Contents](#table-of-contents)

---
<!-- คือ ฟังชั่น Board ที่สามารถใส่ปุ่มบังคับให้ PLAYER ทำตามคำสั่ง โดยมีการ PRINT ให้แสดงผลซึ่งเป็น LOOP เมื่อถึง HAT ถือว่าจบ LOOP , -->